...
qtl.loc <- rbind(c(1,50,0), c(5,80,0), c(10,25,0))
qtl.model <- "y~Q1+Q2+Q3"
# Heritability
h=0.08 # 8%
add.effect=sqrt(4*h/(1-2*h))
effect.vec <- c(add.effect,add.effect,add.effect)
...
filename <- "~/Research/QTL/result/ResultsStepwiseCompareMethods3main8percentv9.RData"
